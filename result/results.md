...
R ≈ 385 px/mm² (426 px 폭) 에서 최대(71 %)이고 그 아래로 무너진다.
골 깊이가 Rayleigh 를 넘는 것은 R ≈ 13.6 까지이고 R ≈ 4.9 에서 0.20 으로
내려간다. 같은 9DTact 카메라에서 힘은 R ≈ 5~17, 형상은 R ≈ 12.3~12.3 에서 포화하는데,
두 점을 가르는 데는 R ≈ 385 이 든다 — **같은 카메라에서 과제가 요구하는 화소 밀도가 스무 배 넘게 벌어진다.**

**전해상도가 여기서도 손해다.** R ≈ 7830 (1920 px 폭) 의 분해 비율이 39 % 로 R ≈ 385 의 71 % 보다 낮다. 골 자체는 얕아지지 않는데(0.384 대 0.464)
**픽셀당 잡음이 4 배**여서(0.108 대 0.026) "골이 자기 잡음의 3 배" 관문이 걸린다. 자국 밝기도 2.15 로 판정 바닥 2.5 아래다.
...
![합력 오차 대 화소 밀도. (a) 굵은 선이 하한, 가는 선과 띠가 상한까지의 폭이다. (b) 제곱합에서 Fz 가 차지하는 몫 — 세 축이 같다면 33 % 다.](extra/figures/I_resultant_force.png)

*합력 오차 대 화소 밀도. (a) 굵은 선이 하한, 가는 선과 띠가 상한까지의 폭이다. (b) 제곱합에서 Fz 가 차지하는 몫 — 세 축이 같다면 33 % 다.*

<sub>그림: `extra/figures/I_resultant_force.png` · 자료: `extra/data/I_resultant_force.csv`</sub>

| 원리 | 합력 오차 바닥 (N) | 그때 폭 | 포화 R | Fz 의 몫 |
|---|---:|---:|---:|---:|
| 9DTact | **0.0597** | 80 px | 4.89 | 59 % |
| DIGIT | **0.0719** | 80 px | 6.49 | 71 % |
| DIGIT_Marker | **0.0909** | 80 px | 22.4 | 77 % |

**합력 오차의 바닥은 원리 순서를 그대로 따른다** — 9DTact 0.060, DIGIT 0.072, DIGIT_Marker 0.091 N. 세 곡선 모두
R ≈ 10 아래에서 가파르게 나빠지고 그 위로는 평평하다.

**합력은 사실상 Fz 다.** 제곱합에서 Fz 의 몫이 9DTact 59 %, DIGIT 71 %, DIGIT_Marker 77 % 로 셋 다 등분선
...
> 얕아 110 % 규칙이 유닛 수에 민감하다 — 같은 계산을 9 유닛으로 하면
> 값이 한두 단 움직인다. 움직이지 않는 것은 **바닥의 크기와 원리 순서**다.

**실무적으로**: 세 원리 모두 합력 오차 0.06 ~ 0.09 N
이고 측정 범위가 0 ~ 2.1 N 이므로 **범위의 3 ~ 4 %** 다. 그 값을
...
<sub>유닛 17 개 — 두께 ρ -0.214 (p 0.409, q 0.783) · 경도 ρ +0.100 (p 0.702, q 0.783)</sub>
...
<sub>유닛 17 개 — 두께 ρ -0.114 (p 0.662, q 0.783) · 경도 ρ +0.214 (p 0.409, q 0.783)</sub>
...
<sub>유닛 18 개 — 두께 ρ -0.446 (p 0.064, q 0.783) · 경도 ρ +0.013 (p 0.959, q 0.959)</sub>
...
<sub>유닛 18 개 — 두께 ρ -0.197 (p 0.434, q 0.783) · 경도 ρ -0.092 (p 0.717, q 0.783)</sub>
...
<sub>유닛 18 개 — 두께 ρ -0.210 (p 0.403, q 0.783) · 경도 ρ -0.223 (p 0.374, q 0.783)</sub>
...
<sub>유닛 18 개 — 두께 ρ +0.170 (p 0.499, q 0.783) · 경도 ρ +0.170 (p 0.499, q 0.783)</sub>
...
![9DTact — 유닛별 지름 오차 대 해상도 (0 이 참 4 mm)](1_9DTact/figures/shape_size_err_vs_resolution_18units.png)

*9DTact — 유닛별 지름 오차 대 해상도 (0 이 참 4 mm)*

<sub>그림: `1_9DTact/figures/shape_size_err_vs_resolution_18units.png` · 자료: `1_9DTact/data/shape_size_err_vs_resolution_18units.csv`</sub>

![DIGIT — 유닛별 지름 오차 대 해상도 (0 이 참 4 mm)](2_DIGIT/figures/shape_size_err_vs_resolution_18units.png)

*DIGIT — 유닛별 지름 오차 대 해상도 (0 이 참 4 mm)*

<sub>그림: `2_DIGIT/figures/shape_size_err_vs_resolution_18units.png` · 자료: `2_DIGIT/data/shape_size_err_vs_resolution_18units.csv`</sub>
...
| 원리 | 지표 | 중앙 포화 해상도 R (px/mm²) | 유닛별 범위 | 해당 픽셀 폭 | n |
|---|---|---:|---|---|---:|
| 9DTact | cyl4 | **12.3** | 1.66 ~ 1,549 | 80×45 | 17 |
| 9DTact | cube4 | **12.3** | 0.68 ~ 7,830 | 80×45 | 17 |
| DIGIT | cyl4 | **2.97** | 0.18 ~ 1,136 | 32×18 | 18 |
| DIGIT | cube4 | **3.16** | 0.21 ~ 1,199 | 32×18 | 18 |

**9DTact — 원기둥 ⌀4 mm**

| 경도 | 1 mm | 2 mm | 3 mm |
|---|---|---|---|
| soft | 2.72 / 69.3 | 4.91 / 14.5 | 4.03 / 12.3 |
| medium | 5.53 / 13.3 | 1,549 | 10.9 / 752 |
| hard | 16.4 / 866 | 2.20 / 59.3 | 1.66 / 11.8 |

<sub>유닛 17 개 — 두께 ρ -0.243 (p 0.347, q 0.783) · 경도 ρ +0.086 (p 0.743, q 0.783)</sub>

**9DTact — 정육면체 4 mm**

| 경도 | 1 mm | 2 mm | 3 mm |
|---|---|---|---|
| soft | 0.68 / 69.3 | 4.91 / 14.5 | 12.3 / 1,275 |
| medium | 2.46 / 13.3 | 7,830 | 3.92 / 188 |
| hard | 2.62 / 1,543 | 2.20 / 59.3 | 3.73 / 11.8 |

<sub>유닛 17 개 — 두께 ρ +0.143 (p 0.584, q 0.783) · 경도 ρ -0.129 (p 0.623, q 0.783)</sub>

**DIGIT — 원기둥 ⌀4 mm**

| 경도 | 1 mm | 2 mm | 3 mm |
|---|---|---|---|
| soft | 3.64 / 83.2 | 0.18 / 2.93 | 0.60 / 2.27 |
| medium | 0.84 / 3.47 | 3.01 / 1,111 | 2.19 / 889 |
| hard | 0.86 / 0.92 | 0.19 / 1,136 | 13.3 / 1,021 |

<sub>유닛 18 개 — 두께 ρ +0.131 (p 0.604, q 0.783) · 경도 ρ +0.170 (p 0.499, q 0.783)</sub>

**DIGIT — 정육면체 4 mm**

| 경도 | 1 mm | 2 mm | 3 mm |
|---|---|---|---|
| soft | 3.64 / 83.2 | 0.71 / 1,173 | 0.57 / 2.38 |
| medium | 0.21 / 3.47 | 0.75 / 6.25 | 2.22 / 875 |
| hard | 0.23 / 0.86 | 2.84 / 1,199 | 212 / 1,021 |

<sub>유닛 18 개 — 두께 ρ +0.262 (p 0.293, q 0.783) · 경도 ρ +0.118 (p 0.641, q 0.783)</sub>
