...
![힘 추정 — 겔 설계에 따른 Fz MAE 와 R². 점 하나가 유닛 하나, 검은 선이 중앙값.](single/extra/figures/J_gel_effect_force.png)

*힘 추정 — 겔 설계에 따른 Fz MAE 와 R². 점 하나가 유닛 하나, 검은 선이 중앙값.*

<sub>그림: `single/extra/figures/J_gel_effect_force.png` · 자료: `single/extra/data/J_gel_effect_force.csv`</sub>

![형상 복원 — 겔 설계에 따른 원기둥 MAE 와 R². 점 하나가 유닛 하나, 검은 선이 중앙값.](single/extra/figures/J_gel_effect_shape.png)

*형상 복원 — 겔 설계에 따른 원기둥 MAE 와 R². 점 하나가 유닛 하나, 검은 선이 중앙값.*
