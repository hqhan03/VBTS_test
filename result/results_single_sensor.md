...
| DIGIT | **0.0699** | 80 px | 2.84 | 69 % |
| DIGIT_Marker | **0.0949** | 320 px | 361 | 79 % |

**합력 오차의 바닥은 원리 순서를 그대로 따른다** — 9DTact 0.058, DIGIT 0.070, DIGIT_Marker 0.095 N. 세 곡선 모두
R ≈ 10 아래에서 가파르게 나빠지고 그 위로는 평평하다.

**합력은 사실상 Fz 다.** 제곱합에서 Fz 의 몫이 9DTact 63 %, DIGIT 69 %, DIGIT_Marker 79 % 로 셋 다 등분선
...
| DIGIT | 전단 | **6.25** | 2.38 ~ 590 | 48×27 | 9 |
...
<sub>유닛 9 개 — 두께 ρ -0.527 (p 0.145, q 0.579) · 경도 ρ +0.211 (p 0.586, q 0.902)</sub>
...
<sub>유닛 9 개 — 두께 ρ -0.158 (p 0.685, q 0.913) · 경도 ρ -0.369 (p 0.329, q 0.821)</sub>
...
<sub>유닛 9 개 — 두께 ρ -0.580 (p 0.102, q 0.509) · 경도 ρ +0.053 (p 0.893, q 0.940)</sub>
...
<sub>유닛 9 개 — 두께 ρ -0.580 (p 0.102, q 0.509) · 경도 ρ +0.000 (p 1.000, q 1.000)</sub>
...
<sub>유닛 9 개 — 두께 ρ -0.053 (p 0.893, q 0.940) · 경도 ρ +0.158 (p 0.685, q 0.913)</sub>
...
| DIGIT | cyl4 | **2.93** | 0.60 ~ 1,136 | 32×18 | 9 |
| DIGIT | cube4 | **6.25** | 0.21 ~ 1,173 | 48×27 | 9 |
...
<sub>유닛 9 개 — 두께 ρ -0.316 (p 0.407, q 0.822) · 경도 ρ -0.264 (p 0.493, q 0.822)</sub>
...
<sub>유닛 9 개 — 두께 ρ +0.422 (p 0.258, q 0.738) · 경도 ρ -0.580 (p 0.102, q 0.509)</sub>
...
| hard | 0.86 | 1,136 | 13.3 |

<sub>유닛 9 개 — 두께 ρ -0.053 (p 0.893, q 0.940) · 경도 ρ +0.264 (p 0.493, q 0.822)</sub>
...
<sub>유닛 9 개 — 두께 ρ +0.474 (p 0.197, q 0.657) · 경도 ρ -0.264 (p 0.493, q 0.822)</sub>
