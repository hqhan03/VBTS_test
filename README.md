...
| 형상 복원에 카메라 해상도가 얼마나 필요한가 (축소 쓸기) | `docs/shape_reconstruction.md` §6 |
| 다른 분석이나 다른 역치로 0.3 mm 보다 깊은 두 점을 분해할 수 있나 | `docs/spatial_resolution.md` §5 |
...
| 이 캠페인의 전처리·학습이 DIGIT/GelSight 문헌과 어디서 갈리나 | `docs/force_estimation.md` §8 |
