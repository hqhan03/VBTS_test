...
|---|---|---|---|---|
| 9DTact | 0.0253 N @ 80 px | 0.0257 @ 80 px | 0.0474 @ 320 px | +53 / +23 / +10 % |
| DIGIT | 0.0269 N @ 48 px | 0.0331 @ 640 px | 0.0611 @ 80 px | +38 / +27 / +12 % |

**두 원리 모두 최소가 중저해상도에 있고 1920 px 는 손해다.** 카메라 대역폭·저장·
연산을 아낄 수 있다는 실용적 결론이 나온다.
...
| 축 | 9DTact 무릎 | DIGIT 무릎 | p (Mann-Whitney) |
|---|---:|---:|---|
| Fx | 48 px | 48 px | 0.758 |
| **Fy** | **80 px** | **40 px** | **0.003** |
| **Fz** | **160 px** | **64 px** | **0.015** |

| 축 | 9DTact 최소 MAE | DIGIT | p |
|---|---:|---:|---|
| Fx | 0.0229 N | 0.0232 | 0.754 |
| **Fy** | **0.0237** | 0.0310 | **0.020** |
| **Fz** | **0.0416** | 0.0557 | **0.00005** |

**두 지표가 반대 방향이다.** DIGIT 은 **적은 픽셀로 자기 한계에 빨리 도달하지만 그
한계가 더 높다**(오차가 크다). 9DTact 는 픽셀을 더 요구하는 대신 더 정확하다.
