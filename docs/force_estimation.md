...
전단 신호 자체의 대역폭을 재면(전단 프레임에서 같은 Fz 의 normal 프레임을 뺀 것의
스펙트럼, 잡음 차감) 90 % 에너지가 **0.30–0.80 cycles/mm** 안에 있고 경도와 ρ = +0.46
(p = 0.06)이다. 19 mm 시야에 Nyquist 로 **11–30 화소**가 필요하다는 뜻이고, 관측된
전단 무릎(16–160 px 폭)과 같은 자리다.
