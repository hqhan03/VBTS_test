...
**U 깊이는 젤 두께를 따라간다** (Spearman ρ = +0.57, p = 0.017, n = 17):
...
경도와는 유의하지 않다(ρ = +0.41, p = 0.098). 두꺼운 젤은 접촉이 넓게 퍼져 자국이
크고, 전단이 만드는 **비대칭**이 그만큼 넓은 공간 구조에 담긴다. 담을 화소가 필요하니
줄였을 때 잃는 것도 크다. 1 mm 젤은 자국 자체가 작아 적은 화소로 충분하다.

> 이것이 §2.3 의 U 자가 통계적 우연이 아니라는 근거다. 그리고 그 U 자가 **왜** 있는지도
> 말해 준다 — 전단이 요구하는 것은 화소 수가 아니라 **자국을 담을 만큼의 화소**이고,
> 그 요구량은 자국의 크기, 즉 젤 두께가 정한다.
