...
**기전은 이 프로브에서 성립하지 않는다**(예측 자체는 §3.5a 에서 맞았다. 기전이 다를 뿐이다). 게다가 불투명한 점이 시야의 약 10 % 를
...
**§3.5 의 결론은 살아남는다.** 접촉당 점이 1.24 개에서 **1.79 개**로 늘지만, 변위
...
점이 1.79 개뿐이라 변위 "장" 을 표본화하지 못한다. 그런데도 해상도가 도움이 된다면,
