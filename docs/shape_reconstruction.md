...
| hard_2mm_r1 | 중앙값 | 19 | **38** | -0.129 | -0.065 | 0.024 | -0.06 | +0.76 | 0.96 |
| soft_3mm_r1 | 빌림 | 16 | **40** | -0.071 | -0.047 | 0.032 | +0.39 | +0.89 | 0.93 |
...
| medium_3mm_r2 | 자체 | 16 | **46** | -0.086 | -0.014 | 0.036 | +0.82 | +1.75 | 0.88 |
| hard_3mm_r2 | 중앙값 | 15 | **48** | -0.155 | -0.113 | 0.019 | +0.18 | +0.92 | 0.94 |
| medium_1mm_r2 | 자체 | 14 | **53** | -0.115 | -0.039 | 0.026 | +0.29 | +0.81 | 0.94 |
| hard_3mm_r1 | 중앙값 | 15 | **54** | -0.138 | -0.057 | 0.026 | +1.04 | +0.91 | 0.95 |
| soft_1mm_r2 | 중앙값 | 14 | **54** | -0.170 | -0.120 | 0.015 | +0.84 | +0.96 | 0.96 |
| hard_1mm_r2 | 중앙값 | 13 | **62** | -0.094 | +0.016 | 0.044 | +0.03 | +0.69 | 0.92 |
| soft_1mm_r1 | 자체 | 12 | **64** | -0.128 | -0.073 | 0.031 | -0.16 | +0.10 | 0.90 |
| medium_3mm_r1 | 빌림 | 9 | **68** | -0.149 | -0.148 | 0.021 | -0.09 | +0.72 | 0.96 |
...
|---|---|---|---|---|---|
| 자체 | 7 | +0.13 mm | +0.44 mm | 0.93 | 0.026 |
| 중앙값 | 5 | +0.18 mm | +0.91 mm | 0.95 | 0.024 |
| 빌림 | 5 | +0.70 mm | +1.22 mm | 0.93 | 0.032 |

자체 축척을 가진 유닛에서는 **지름 4.00 mm 원판이 4.13 mm 로, 정사각형은 변 4.44 mm · 변 비 0.93 로**
...
**축척을 다른 런에서 빌린 유닛은 형상이 눈에 띄게 나쁘다** — 지름 오차 +0.70 mm, 변 오차
+1.22 mm, 정사각성 0.93. 깊이 잔차(RMS)는 비슷하므로 밝기→깊이 표는 멀쩡하고, 틀린 것은 **이방성과
...
| 두께 \ 경도 | soft | medium | hard |
|---|---|---|---|
| 1 mm | -0.16, +0.84† | +0.13, +0.29 | +0.08, +0.03† |
| 2 mm | -0.07, +0.70† | +1.17† | -0.06, +0.26† |
| 3 mm | +0.39, +1.11† | -0.09, +0.82† | +1.04, +0.18† |

**cube4 정사각성** (칸마다 r1, r2 순; † = 자체 축척이 아닌 유닛 포함)

| 두께 \ 경도 | soft | medium | hard |
|---|---|---|---|
| 1 mm | 0.90, 0.96† | 1.00, 0.94 | 0.92, 0.92† |
| 2 mm | 0.93, 0.90† | 0.84† | 0.96, 0.99† |
| 3 mm | 0.93, 0.97† | 0.96, 0.88† | 0.95, 0.94† |
