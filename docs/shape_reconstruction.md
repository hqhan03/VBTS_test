...
**깊이 분해능 µm/단계** (칸마다 r1, r2 순; † = 자체 축척이 아닌 유닛 포함)
...
**선형 보정 후 RMS mm** (칸마다 r1, r2 순; † = 자체 축척이 아닌 유닛 포함)
...
**cyl4 깊이 편향 (≥0.3 mm) mm** (칸마다 r1, r2 순; † = 자체 축척이 아닌 유닛 포함)

| 두께 \ 경도 | soft | medium | hard |
|---|---|---|---|
| 1 mm | -0.073, -0.120† | -0.006, -0.039 | -0.014, +0.016† |
| 2 mm | +0.002, -0.050† | -0.082† | -0.065, +0.051† |
| 3 mm | -0.047, -0.071† | -0.148, -0.014† | -0.057, -0.113† |

**cyl4 지름 오차 mm** (칸마다 r1, r2 순; † = 자체 축척이 아닌 유닛 포함)
...
**cube4 정사각성** (칸마다 r1, r2 순; † = 자체 축척이 아닌 유닛 포함)
