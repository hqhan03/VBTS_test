...
| 두께 \ 경도 | soft | medium | hard |
|---|---|---|---|
| 1 mm | 0.92, 0.72 | 0.70, 0.53 | 0.70, 0.77 |
...
- **2 mm 행이 세 경도 모두에서 가장 많이 가른다** (soft 2·3, medium 3, hard 4·3 —
  2 mm 다섯 유닛이 15/20). 1 mm 행은 9/24, 3 mm 행은 4/24 이다.
  (2026-09-08 에 17 유닛 모두 실측 축척으로 바뀌었다. 칸 값은 조금씩 움직였지만
  행의 순서는 그대로다: 2 mm > 1 mm > 3 mm.)
