...
ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))); D = lambda *p: os.path.join(ROOT, "data", "20260911_VBTSresolution_dataset", "9DTact", *p)
