...
`src/config/sensor_registry.yaml` 에 적힌 천장과 일치해야 하고, 일치하지 않으면
...
격자와 램프가 다른 런에서 나온 12 유닛은 램프 옆 PROVENANCE.yaml 이 출처를 담는다.
    ...
    python3 src/scripts/ceiling_summary.py            # 표를 다시 쓴다
    python3 src/scripts/ceiling_summary.py --check    # 등록부와 맞춰만 본다
"""
import argparse
import re
