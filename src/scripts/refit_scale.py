...
`refit_from_frames_at` recording when and `refit_note` recording why.
    ...
    src/scripts/refit_scale.py                    # every run in the dataset
    src/scripts/refit_scale.py --unit 9DTact_medium_1mm_r2   # one unit's runs
    src/scripts/refit_scale.py --dry-run          # report, write nothing
"""
import argparse
import csv
