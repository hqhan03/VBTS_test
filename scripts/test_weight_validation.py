...
no robot access.
    ...
    /usr/bin/python3 scripts/test_weight_validation.py --compare-mappings
...
def main() -> int:
    ...
    if args.compare_mappings:
        ...
        if comparison[best]["passed"]:
            ...
            print("     and daq.channel_mapping_confirmed: true in config/ft_config.yaml")
        else:
    ...
    if passed:
        ...
        print("You may now set daq.channel_mapping_confirmed: true in config/ft_config.yaml.")
    else:
