...
data/9DTact/shape_vs_force.csv and prints what survives.
"""
...
ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__))); D = lambda *p: os.path.join(ROOT, "data", "9DTact", *p)
